./instant-ngp-train --step=30000 -c configs/nerf/base_16.json --save_snapshot results/basketball-base_16-frame0.bson data/nerf/basketball/img/0
./instant-ngp-train --step=30000 -c configs/nerf/base_16.json --save_snapshot results/basketball-base_16-mask-frame0.bson data/nerf/basketball/img/0/mask
./instant-ngp-train --step=30000 -c configs/nerf/base_15.json --save_snapshot results/basketball-base_15-frame0.bson data/nerf/basketball/img/0
./instant-ngp-train --step=30000 -c configs/nerf/base_15.json --save_snapshot results/basketball-base_15-mask-frame0.bson data/nerf/basketball/img/0/mask
