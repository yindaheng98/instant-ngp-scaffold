...
command0() {
    ./build/instant-ngp-replay \
        ...
        --savecam $4 \
        --gethit results/$3/gridhit/M=$5/$6/frame%d-modified.bson \
        --M_blimit $5 \
        --save_image results/$3/gridhit/M=$5/$6/img/gt/%d-modified.bin
}
command1() {
    ./build/instant-ngp-replay \
        --start $1 --end $2 \
        --load_snapshot results/$3/frame1.bson \
        --init results/$3/intra/frame1.bson \
        --frameformat results/$3/gridhit/M=$5/$6/frame%d-modified.bson \
        --savecam $4 --directcam \
        --M_blimit $5 \
        --save_image results/$3/gridhit/M=$5/$6/img/lr/%d-modified.bin
}
command2() {
    python scripts/eval_cameras.py \
        --start $1 --end $2 \
        --modelformat results/$3/gridhit/M=$5/$6/frame%d-modified.bson \
        --gtformat results/$3/gridhit/M=$5/$6/img/gt/%d-modified.bin \
        --lrformat results/$3/gridhit/M=$5/$6/img/lr/%d-modified.bin \
